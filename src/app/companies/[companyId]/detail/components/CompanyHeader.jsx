// src/app/companies/[companyId]/detail/components/CompanyHeader.jsx
    ...
    >
      ...
      <div className="relative flex flex-col sm:flex-row items-center gap-6">
        <Avatar className="w-20 h-20 sm:w-24 sm:h-24 ring-4 ring-white/20">
          <AvatarImage src={company.logo || '/placeholder.png'} alt={`${company.name} logo`} />
        ...
        <div className="text-center sm:text-left flex-1">
          ...
          <div className="flex justify-center sm:justify-start gap-4 mt-4">
            {company.linkedin && (
              <a href={company.linkedin} className="text-blue-200 hover:text-white transition">
                <Linkedin size={20} />
              </a>
            )}
